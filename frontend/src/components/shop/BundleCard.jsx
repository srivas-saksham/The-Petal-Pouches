    ...
    <div className={`bg-white dark:bg-tppdarkgray rounded-lg border border-tppgrey dark:border-tppdarkwhite/10 shadow-sm hover:shadow-md hover:border-tppslate/60 dark:hover:border-tppdarkwhite/20 transition-all duration-200 overflow-hidden group ${isInCart ? 'border-2 border-tpppink dark:border-tppdarkwhite/40' : ''}`}>
      ...
      >
        ...
        <div className="hidden md:block w-full h-full">
          ...
          {currentImage ? (
            <img
              ...
              onError={(e) => { e.target.src = '/placeholder-bundle.png'; setImageLoaded(true); }}
            />
          ) : (
            <div className="w-full h-full flex items-center justify-center bg-slate-50 dark:bg-tppdark">
          ...
          {hasMultipleImages && (
            <>
              ...
              >
                <ChevronLeft size={16} className="text-slate-700 dark:text-tppdarkwhite group-hover/arrow:text-tpppink dark:group-hover/arrow:text-tppdarkwhite transition-colors" />
              </button>
              ...
              >
                <ChevronRight size={16} className="text-slate-700 dark:text-tppdarkwhite group-hover/arrow:text-tpppink dark:group-hover/arrow:text-tppdarkwhite transition-colors" />
              </button>
            </>
          )}
        </div>
        ...
        {!isOutOfStock && bundleItems.length > 0 && (
          <div className="font-inter absolute top-1 md:top-2 right-1 md:right-2 bg-tpppink dark:bg-tppdarkwhite text-white dark:text-tppdark text-[10px] md:text-xs font-semibold px-1.5 md:px-2 py-0.5 md:py-1 rounded-md flex items-center gap-0.5 md:gap-1 shadow-sm z-10">
              ...
              <div className='flex items-center gap-1 md:gap-2'>
                <button
                  ...
                  className={`w-full flex items-center justify-center gap-1 md:gap-1.5 py-1 md:py-1.5 rounded border font-medium text-[9px] md:text-xs transition-all ${
                    updating
                      ? 'border-tppgrey dark:border-tppdarkwhite/20 text-tppslate/40 dark:text-tppdarkwhite/20 cursor-not-allowed'
                      : 'border-red-500 dark:border-red-500 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 active:scale-95'
                  }`}
                >
