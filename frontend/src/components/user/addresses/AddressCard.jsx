 ...
 * @param {string} layout - Layout type: "2-column" or "3-column"
    ...
    return (
      ...
      >
        ...
        <div className="p-5 flex gap-4">
          {/* LEFT: Address Details - Takes remaining space */}
