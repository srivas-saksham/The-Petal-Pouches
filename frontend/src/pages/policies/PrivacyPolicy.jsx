    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-tppdark py-6 sm:py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-tppdarkgray shadow-sm rounded-lg p-6 sm:p-8 md:p-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-tppdarkwhite mb-2">Privacy Policy</h1>
          ...
          <div className="space-y-6 sm:space-y-8 text-gray-700 dark:text-tppdarkwhite/70">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">2. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">3. How We Use Your Information</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">4. Payment Security</h2>
              <p className="leading-relaxed text-sm sm:text-base">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">5. Data Sharing and Disclosure</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">6. Cookies</h2>
              <p className="leading-relaxed text-sm sm:text-base">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">7. Data Security</h2>
              <p className="leading-relaxed text-sm sm:text-base">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">8. Your Rights</h2>
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">9. Data Retention</h2>
              <p className="leading-relaxed text-sm sm:text-base">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">10. Children's Privacy</h2>
              <p className="leading-relaxed text-sm sm:text-base">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">11. Changes to This Policy</h2>
              <p className="leading-relaxed text-sm sm:text-base">
            ...
            <section>
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-tppdarkwhite mb-3 sm:mb-4">12. Contact Us</h2>
